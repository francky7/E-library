												  ...
												  <div class="chrt-inner">
												    <div class="chrt-bars">
														<div class="col-md-6 chrt-two">
														 <center><h3 class="sub-tittle">Bar Chart </center></h3>
															<div id="chart2"></div>
			...
			<!--/down-->
                           ...
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Statistics</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Tabs &amp; Panels</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="tabs.html"> Students</a></li>
